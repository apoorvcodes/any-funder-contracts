...
contract AppRegistry is AccessControlEnumerable {
    ...
    mapping(address => string) private _settings;
    ...
    function getDeployment(address user)
        public
        view
    ...
    function addDeployment(address user, address deployment)
        public
    ...
    function removeDeployment(address user)
        public
        deploymentExists(user, true)
        isOperatorOrOwner(user)
    {
